...
public class GoogleRecognitionServiceImpl extends AIService {
    ...
    protected void onPartialResults(final List<String> partialResults, boolean partial) {
        if (partialResultsListener != null) {
            partialResultsListener.onPartialResults(partialResults, partial);
        }
    }
        ...
        public void onResults(final Bundle results) {
            if (recognitionActive) {
                ...
                if (recognitionResults == null || recognitionResults.isEmpty()) {
                    ...
                    GoogleRecognitionServiceImpl.this.onPartialResults(recognitionResults, false);
        ...
        public void onPartialResults(final Bundle partialResults) {
            if (recognitionActive) {
                ...
                if (partialRecognitionResults != null && !partialRecognitionResults.isEmpty()) {
                    GoogleRecognitionServiceImpl.this.onPartialResults(partialRecognitionResults, true);
                }
            }
        }
